"""
Создание БД с таблицей дневных котировок фьючерса RTS конвертированных из минутных данных
...
def add_tradedate_future(connection, cursor, tradedate, open, low, high, close, volume):
    """Добавляет строку в таблицу Day """
    with connection:
        return cursor.execute(
            "INSERT INTO `Day` (`TRADEDATE`, `OPEN`, `LOW`, `HIGH`, `CLOSE`, `VOLUME`) VALUES(?,?,?,?,?,?)",
...
if __name__ == '__main__':  # Создание БД, если её не существует
    ...
    file_bd: str = f'{tiker}_futures_minute_to_day_converter.db'
